"""
compare_claims_v2.py  —  Claim Comparison with Multi-Dimensional Annotation Scheme
...
Writes to:
    computations/data/data_sources/claims/claim_changes_v2.jsonl
    computations/data/data_sources/claims/claim_changes_v2_flat.csv
    computations/analysis/outputs/comparison_v2_report.txt

Usage:
    cd <project_root>
    export OPENAI_API_KEY="sk-..."          # or set in config/openai_key.txt
    python3 computations/analysis/scripts/analysis/compare_claims_v2.py

    # Pilot mode (first 50 pairs only — run this before the full run):
    python3 computations/analysis/scripts/analysis/compare_claims_v2.py --pilot
...
OUT_REPORT   = PROJECT_ROOT / "computations" / "analysis" / "outputs" / "comparison_v2_report.txt"
...
async def main(pilot: bool = False):
    print("=== Claim Comparison v2: Multi-Dimensional Annotation ===\n")
